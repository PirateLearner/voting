...
$(document).ready(function(){
	...
	var receiveVoteStats = function(){
		...
		$.ajax({
		    ...
		    url: 'http://127.0.0.1:8000/voting/blogcontent/'+pirateLearnerGlobal.voting.id+'/',
	...
	var confirmVote = function(data){
		pirateLearnerGlobal.voting.vote_id = data['id'];
	...
	var validateAndSend = function(e){
		vote = 0;
		method = "POST";
		postUrl = "http://127.0.0.1:8000/voting/votes/";
	 ...
	 */	
	pirateLearnerGlobal.voting.id = parseInt($('.voting').attr('data-id'));
	pirateLearnerGlobal.voting.content_type = parseInt($('.voting').attr('data-content-type'));
	/*
